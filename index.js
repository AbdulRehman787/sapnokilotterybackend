...
app.post('/register', (req, res) => {
    ...
    const checkEmailSql = "SELECT * FROM `signupdata` WHERE `email` = ?";
    db.query(checkEmailSql, [email], (err, results) => {
        ...
        bcrypt.hash(req.body.password, saltRounds, (err, hash) => {
            ...
            const sql = "INSERT INTO `signupdata`(`name`, `email`, `phoneno`, `password`) VALUES (?, ?, ?, ?)";
            const values = [
                req.body.name,
                req.body.email,
                req.body.phoneno,
...
app.post('/forgotpassword', (req, res) => {
    ...
    db.query(sql, [email], (err, results) => {
        ...
        const updateSql = "UPDATE `signupdata` SET `reset_token` = ?, `reset_token_expire` = ? WHERE `email` = ?";
